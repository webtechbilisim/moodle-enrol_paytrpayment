...
class PayTr
{
    ...
    protected $email;
    protected $user_address   = "Istanbul";
    protected $user_phone     = "08508406086";
    protected $user_name;
    ...
    */
	...
	/*
    *   SET PAYMENT ORDER ID BY KEY VALUE
    */
    public function setMerchantOrderIdByVal($val){
      $this->merchant_oid = $val;
    }
    ...
    */
    ...
    public function initialize(){
      ...
      if($result['status']=='success')
      {
		...
		print_r($result);
        die("PAYTR IFRAME connection error. err:");
      }
    }
}