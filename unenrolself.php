...
$instance = $DB->get_record('enrol', array('id' => $enrolid, 'enrol' => 'paytrpayment'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/paytrpayment/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_paytrpayment', format_string($course->fullname));
